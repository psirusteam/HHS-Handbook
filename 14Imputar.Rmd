...
```{r, fig10, fig.cap="Distribución de los ingresos (izquierda y centro) y Relación entre los valores predichos e imputados para los hogares con datos de ingresos faltantes (derecha).", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/10.png")
```
...
```{r, fig11, fig.cap="Distribución de las probabilidades estimadas de compra de arroz (izquierda) y valores imputados para los hogares con valores faltantes en el filtro (derecha).", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/11.png")
```
...
```{r, fig12, fig.cap="Distribución de la probabilidad estimada de compra de un artículo de bajo consumo (izquierda) y sus valores imputados para los hogares que no respondieron el filtro (derecha).", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/12.png")
```
...
```{r, fig13, fig.cap="Distribución de los gastos imputados sobre el salmón (izquierda) y relación entre los valores predichos e imputados para los hogares con valores faltantes en el gasto (derecha).", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/13.png")
```
...
```{r, figim1, fig.cap="Relación de la variable de interés para los datos completos (izquierda) y con ausencia de valores (derecha).", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/im1.png")
```
...
```{r, figim2, fig.cap="Relación de la variable de interés con la covariable auxiliar para el enfoque de imputación ingenua.", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/im2.png")
```
...
```{r, figim3, fig.cap="Relación de la variable de interés con la covariable auxiliar para el enfoque de imputación múltiple Bootstrap", echo=FALSE, out.width='50%'}
knitr::include_graphics("Pics/im3.png")
```

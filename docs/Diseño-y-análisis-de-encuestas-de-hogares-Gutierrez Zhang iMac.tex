...
\addcontentsline{toc}{subsection}{Recorte de pesos extremos}
...
\addcontentsline{toc}{subsection}{El problema del redondeo de los factores de expansión}
...
\addcontentsline{toc}{subsubsection}{Estimaciones negativas de varianza}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.16}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.21}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.21}}@{}}
\toprule
...
\addcontentsline{toc}{subsubsection}{Disminución de la varianza ante el aumento del tamaño de muestra}
...
posible riesgo de estimadores sesgados. Por ejemplo, \citet{Shlomo_Skinner_Schouten_2012} estudian el uso de los \emph{indicadores de representatividad} que permiten conocer qué tanto la muestra de respondientes efectivos representa a la población y cómo la composición
...
\addcontentsline{toc}{subsubsection}{MCAR}
...
\addcontentsline{toc}{subsubsection}{MAR}
...
\addcontentsline{toc}{subsubsection}{NMAR}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/el3a} \caption{Distribución de las probabilidades estimadas de respuesta: respondientes (arriba), no respondientes (medio), ambos (abajo).}\label{fig:figel3a}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/el3b} \caption{Balanceo entre respondientes y no respondientes}\label{fig:figel3b}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/c9} \caption{Estimaciones de Horvtiz-Thompson y de calibración.}\label{fig:fightcal}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/c10} \caption{Distribuciones del estimador de Horvtiz-Thompson y del estimador de calibración}\label{fig:fightcaldist}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/c12} \caption{Distribuciones del estimador de Horvtiz-Thompson y de dos estimadores de calibración}\label{fig:fightcal2dist}
\end{figure}

\hypertarget{la-pandemia-por-covid-19}{%
\section{La pandemia por COVID-19}\label{la-pandemia-por-covid-19}}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/calnr1} \caption{Distribuciones del estimador de Horvtiz-Thompson en tres escenarios de interés.}\label{fig:fight3dist}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/calnr2} \caption{Distribuciones del estimador de Horvtiz-Thompson y de dos estimadores ajustados.}\label{fig:fight4dist}
\end{figure}
...
\subsubsection*{Imputación por paquete caliente (Hot-Deck)}\label{imputaciuxf3n-por-paquete-caliente-hot-deck}}
\addcontentsline{toc}{subsubsection}{Imputación por paquete caliente (Hot-Deck)}
...
\subsubsection*{Simulación empírica}\label{simulaciuxf3n-empuxedrica}}
\addcontentsline{toc}{subsubsection}{Simulación empírica}
...
\addcontentsline{toc}{subsubsection}{Método Top-Down}
...
\addcontentsline{toc}{subsubsection}{Método de boxplot}
...
\addcontentsline{toc}{subsubsection}{Transformación de Box-Cox}
...
\addcontentsline{toc}{subsubsection}{Método de distancia estandarizada}
...
\addcontentsline{toc}{subsubsection}{Método de Hidiroglou-Bertholot}
...
\addcontentsline{toc}{subsubsection}{Método de la distancia de Mahalanobis}
...
\subsubsection*{La distancia de Cook}\label{la-distancia-de-cook}}
\addcontentsline{toc}{subsubsection}{La distancia de Cook}
...
\subsubsection*{El criterio DFBETAS}\label{el-criterio-dfbetas}}
\addcontentsline{toc}{subsubsection}{El criterio DFBETAS}
...
\hypertarget{cambios-netos-1}{%
\subsubsection*{Cambios netos}\label{cambios-netos-1}}
\addcontentsline{toc}{subsubsection}{Cambios netos}
...
\addcontentsline{toc}{subsubsection}{Promedio trimestral}
...
\addcontentsline{toc}{subsubsection}{Pesos básicos}
...
\addcontentsline{toc}{subsubsection}{Definición de la población longitudinal}
...
\addcontentsline{toc}{subsubsection}{Ausencia de respuesta y atrición}
...
\addcontentsline{toc}{subsubsection}{Calibración de los pesos logitudinales}
...
\addcontentsline{toc}{subsubsection}{Intervalos de confianza}
...
\addcontentsline{toc}{subsubsection}{Coeficientes de variación}
...
\addcontentsline{toc}{subsubsection}{Coeficiente de variación logarítmico}
...
\addcontentsline{toc}{subsubsection}{El efecto de diseño DEFF}
...
\addcontentsline{toc}{subsubsection}{Tamaño de muestra}
...
\addcontentsline{toc}{subsubsection}{Tamaño de muestra efectivo}
...
\addcontentsline{toc}{subsubsection}{Grados de libertad}
...
\addcontentsline{toc}{subsubsection}{Conteo de casos no ponderado}
...
\addcontentsline{toc}{subsection}{Variables y subpoblaciones}
...
\addcontentsline{toc}{subsection}{Secuencia lógica para crear reglas de supresión}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.46}}

...
\addcontentsline{toc}{subsubsection}{Sesgo de selección}
...
\addcontentsline{toc}{subsubsection}{Sesgo de medición}
...
\begin{figure}
\centering
\includegraphics{05Estratificar_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(}\FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{p }\SpecialCharTok{*} \FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{Est.HT)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(}\FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{p }\SpecialCharTok{*} \FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{Est.Var1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(}\FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{p }\SpecialCharTok{*} \FunctionTok{VarSYGHT}\NormalTok{(x, N, n, p)}\SpecialCharTok{$}\NormalTok{Est.Var2)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{12Ausencia_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{12Ausencia_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{12Ausencia_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\addcontentsline{toc}{subsubsection}{La distancia de Cook y el criterio DFBETAS}
...
\addcontentsline{toc}{subsubsection}{Algunas estructuras de varianza}
...
\addcontentsline{toc}{subsubsection}{Estadístico de prueba}
...
\begin{figure}
\centering
\includegraphics{19Calidad_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\hypertarget{definiciuxf3n-de-los-paruxe1metros-y-variables-de-diseuxf1o}{%
\subsection*{Definición de los parámetros y variables de diseño}\label{definiciuxf3n-de-los-paruxe1metros-y-variables-de-diseuxf1o}}
...
\hypertarget{consolidaciuxf3n-del-marco-de-muestreo}{%
\subsection*{Consolidación del marco de muestreo}\label{consolidaciuxf3n-del-marco-de-muestreo}}
...
\hypertarget{diseuxf1o-de-muestreo}{%
...
\hypertarget{definiciuxf3n-de-los-factores-de-expansiuxf3n}{%
\subsection*{Definición de los factores de expansión}\label{definiciuxf3n-de-los-factores-de-expansiuxf3n}}
...
Para las encuestas que han sido planeadas de forma que sigan a los hogares a lo largo del tiempo (panel, split panel, rotativas). Ver por ejemplo \citet{IBGE_2014}
...
\hypertarget{definiciuxf3n-de-los-estimadores}{%
\subsection*{Definición de los estimadores}\label{definiciuxf3n-de-los-estimadores}}

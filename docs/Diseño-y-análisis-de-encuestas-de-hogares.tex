...
1. Ejecución de múltiples escenarios de estratificación de las UPM utilizando información agregada del censo\footnote{Aunque también es posible añadir información geoespacial, catastral o de cualquier índole si se tiene una cobertura completa a nivel de las UPM.}.
...
\section{Efecto de la estratificación en las estrategias de muestreo}\label{efecto-de-la-estratificaciuxf3n-en-las-estrategias-de-muestreo}}

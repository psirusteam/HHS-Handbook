...
\begin{figure}
\centering
\includegraphics{10Ausencia_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{10Ausencia_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{10Ausencia_files/figure-latex/unnamed-chunk-3-1.pdf}
...
Al aplicar una imputación ingenua sobre el conjunto de datos creado, se obtiene un conjunto de datos completo, ejemplificado (solo las primeras diez filas de la base) en la siguiente tabla:
...
En general, usar un enfoque ingenuo no afecta la estimación puntual del parámetro de interés, sino la estimación del error estándar, puesto que la variación natural de los datos se subestima dramáticamente. Por ejemplo, la siguiente figura muestra que con la imputación ingenua, todos los valores faltantes imputados están sobre la línea de regresión.
...
En resumen, a partir de esta simulación de Monte Carlo, se concluye rápidamente que imputar ingenuamente constituye un error técnico grave. La siguiente tabla muestra que los tres métodos de imputación arrojaron estimaciones puntuales insesgadas. Sin emabrgo, el error estándar de la estimación ingenua es gravemente subestimado. De esta forma, la amplitud de los intervalos de confianza al 95\% inducidos por la estimación ingenua es inferior al de los otros dos métodos, causando que la cobertura del método ingenuo sea deficiente, pues su nivel nominal en realidad no es del 95\%, sino del 83\%.
1.

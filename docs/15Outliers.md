...
## Ejemplo: detección de valores atípicos en una encuesta de presupeustos familiares y gastos
...
![(\#fig:figou1)Valores óptimos para las transformaciones de Box-Cox en algunas categorías del gasto.](Pics/ou1.png){width=50%}

...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/j2} \caption{Imputación total: todas las unidades que no respondieron son imputadas (las celdas en gris indican los valores que fueron imputados).}(\#fig:figimptotal)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/j3} \caption{Ponderación total: cada variable tendrá un conjunto de pesos diferente. No se utiliza ningún método de imputación.}(\#fig:figpondtotal)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{Pics/j4} \caption{Enfoque de eliminación: únicamente se consideran las unidades que respondedieron a todas las varaibles.}(\#fig:figelimtotal)
\end{figure}

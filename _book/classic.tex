...
\begingroup
\color{Maroon}\spacedallcaps{Diseño y análisis estadístico en las encuestas de hogares de América Latina} \\ \bigskip % Thesis title

\endgroup

\spacedlowsmallcaps{Andrés Gutiérrez} % Your name

\vfill

\includegraphics[width=6cm]{Pics/logo-cepal.jpg} \\ \medskip % Picture
...
{\centering \includegraphics[width=0.9\linewidth]{classic_files/figure-latex/unnamed-chunk-2-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{classic_files/figure-latex/unnamed-chunk-3-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{classic_files/figure-latex/unnamed-chunk-4-1} 

...
\hypertarget{imputaciuxf3n}{%
\section{Imputación}\label{imputaciuxf3n}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.09}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.14}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.15}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.02}}@{}}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.12}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.09}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.09}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.15}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.06}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.16}}@{}}
